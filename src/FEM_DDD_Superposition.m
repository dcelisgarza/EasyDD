function [f_bar, f_hat, f_tilda, u_bar, u_hat, u_tilda, r_hat] = FEM_DDD_Superposition(...
        ...
        f_dot, f_bar_0, u_tilda_0, u, u_hat, u_tilda, loading, calculateTractions, gamma_dln, ...
    ...
    [u, u_bar, f, f_bar, calculateR_hat] = loading(u, u_dot, sign_u_dot, u_bar_0, ...
        f, f_dot, sign_f_dot, f_bar_0, ...
