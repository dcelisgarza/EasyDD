...
while simTime < totalSimTime
    ...
    [f_bar, f_hat, f_tilda, u_bar, u_hat, u_tilda, r_hat] = FEM_DDD_Superposition(...
        ...
        freeDofs, dx, dy, dz, simTime, holdingTime, mx, my, mz, sign_u_dot, u_dot, u_bar_0, sign_f_dot, ...
    ...
    [rnnew, vn, dt, fn, fseg] = integrator(rn, dt, dt0, dtMin, MU, NU, a, Ec, links, connectivity, ...
        rmax, rntol, mobility, vertices, rotMatrix, u_hat, nc, xnodes, D, mx, my, mz, w, h, d, Bcoeff, CUDA_flag);
    ...
    [rnnew, linksnew, connectivitynew, linksinconnectnew, fsegnew] = remeshPreCollision(rnnew, linksnew, ...
        ...
        TriangleCentroids, TriangleNormals, CUDA_flag, Bcoeff, noExitNorm, noExitPoint);
   ...
   [rnnew, linksnew, connectivitynew, linksinconnectnew, fsegnew] = collideAndSeparateNodesAndSegments(docollision, doseparation, ...
    ...
    [rnnew, linksnew, connectivitynew, linksinconnectnew, fsegnew, ~] = separation(doseparation, rnnew, ...
        ...
        2 * rann, vertices, u_hat, nc, xnodes, D, mx, my, mz, w, h, d, CUDA_flag, Bcoeff,0);
    ...
    [rnnew, linksnew, connectivitynew, linksinconnectnew, fsegnew] = remesh_all(rnnew, linksnew, ...
        ...
        TriangleNormals, CUDA_flag, Bcoeff, noExitNorm, noExitPoint);
