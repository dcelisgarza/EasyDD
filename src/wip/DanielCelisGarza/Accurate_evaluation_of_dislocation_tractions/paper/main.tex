...
\begin{figure}
    \centering
    \subfloat[Full rotation of a segment.]{{\includegraphics[width=0.8\linewidth]{ftot_rotation_lin_rect.pdf}}}

    \subfloat[Zoom of the rotation of a segment $\pm 10~\text{deg}$.]{{\includegraphics[width=0.8\linewidth]{ftot_rotation_lin_rect_zoom.pdf}}}
...
\begin{figure}
    ...
    {
        {\includegraphics[width=0.3\linewidth]{images/sxzperpEdgeFiveb.pdf}}
    }
    ~
    \subfloat[\label{sf:yzeperp}]
    {
        {\includegraphics[width=0.3\linewidth]{images/syzperpEdgeFiveb.pdf}}
    }
    ~
    \subfloat[\label{sf:zzeperp}]
    {
        {\includegraphics[width=0.3\linewidth]{images/szzperpEdgeFiveb.pdf}}
    }
