...
\begin{figure}
    ...
    {
        {\includegraphics[trim={0.5cm 0cm 0cm 0cm},clip,width=0.3\linewidth]{images/sxxEparTot3.pdf}}
    }~
    \subfloat[$\sigma^\textrm{A}_{x}$.\label{sf:sxxAepartot2}]
    {
        {\includegraphics[trim={0.5cm 0cm 0cm 0cm},clip,width=0.3\linewidth]{images/sxxAEparTot3.pdf}}
    }~
    \subfloat[$\sigma^\textrm{N}_{xx}$.\label{sf:sxxNepartot2}]
    {
        {\includegraphics[trim={0.5cm 0cm 0cm 0cm},clip,width=0.3\linewidth]{images/sxxNEparTot3.pdf}}
    }
...
\begin{figure}
    ...
    {
        {\includegraphics[width=0.3\linewidth]{images/line_sxxEparTot3.pdf}}
    }~
